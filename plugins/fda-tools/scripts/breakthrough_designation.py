...
All templates, timelines, and progress tracking produced by this module are
for PLANNING AND RESEARCH purposes only. They should NOT be submitted to FDA
without independent review by qualified regulatory affairs professionals.
Breakthrough Device Designation eligibility depends on device-specific
characteristics, clinical evidence, and FDA review team assessment that cannot
be fully captured by automated tools. ALWAYS consult qualified regulatory
professionals before submitting designation requests to FDA.
...
REGULATORY DISCLAIMER:
This output is generated by automated tools for PLANNING AND RESEARCH
purposes only. It should NOT be used as the sole basis for regulatory
decisions or submitted to FDA without independent review by qualified
regulatory affairs professionals. Breakthrough Device Designation
eligibility depends on device-specific characteristics and FDA
reviewer assessment that cannot be fully captured by automated tools.

ALWAYS consult with qualified regulatory affairs professionals and
consider submitting a Pre-Submission (Q-Submission) to FDA for guidance.
"""
...
class BreakthroughDesignation:
    ...
    REGULATORY DISCLAIMER:
    All templates and tracking outputs are for PLANNING AND RESEARCH purposes
    only. They should NOT be submitted to FDA without independent review by
...
def main():
    ...
    # Print regulatory disclaimer to stderr for all commands
